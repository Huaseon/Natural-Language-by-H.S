...
import pandas as pd
print("source: analysis_result_simple_format_3000_with_summary.xlsx")
df = pd.read_excel('./data/analysis_result_simple_format_3000_with_summary.xlsx')
print(df.head())
print()
...
plt.savefig('./data/loss-plot_A(98).svg')
plt.close()

model.save(save_model='./data/text_assessor_A(98).pth')
...
plt.savefig('./data/loss-plot_B(119).svg')
plt.close()

model.save(save_model='./data/text_assessor_B(119).pth')
